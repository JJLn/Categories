...
{
    CGSize size = {imgSrc.size.width, imgSrc.size.height};
    if (imgSrc.size.width > 800) {
//        size.width = imgSrc.size.width/3;
//        size.height = imgSrc.size.height/3;

        size.width = imgSrc.size.width/(imgSrc.size.width / 800);
        size.height  =imgSrc.size.height/((imgSrc.size.width / 800));
