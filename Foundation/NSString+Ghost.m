...
- (NSString *)insideNumber{
    ...
    [scanner scanUpToCharactersFromSet:[NSCharacterSet decimalDigitCharacterSet] intoString:&result];
    return result;
}
...
- (NSString *)dateStrFromTimestamp:(NSString *)formatter{
    NSTimeInterval time = [self doubleValue];
    ...
    return FQAHStringFromDate(formatter, confromTimesp);
